...
//featured highlight
/*$('.private_highlight .highlight_text').each(function(){
  if ($(this).find('p.desc').text().length == "") {}
...
$('html.club_scripts_account_view_account .content-right font h1 b:contains("View Account Statements")').replaceWith("View Account Statements");  
...
$('html.club_scripts_account_view_account .content-right td p font b').replaceWith("Sorry but there is no statement information on file for your account. <br> <br>     Please contact Eagle Oaks Golf & Country Club for additional information.  ");

//Club Personnel
$("html.club_scripts_clubpers_view_clubpers_list .content-right h1.title").prependTo($(".private .content-right"));
...
//Reservation
$('html.club_scripts_facilities_facility_reservation .content-right br').first().hide();
$('html.club_scripts_facilities_facility_reservation .content-right font b:contains("Reservation Request Form")').wrap('<h1 class="title"/>');

//CALENDAR
/*full calendar page*/
$('<h1>Club Calendar</h1>').prependTo('html.club_scripts_calendar_weekly_calendar .content-right');
